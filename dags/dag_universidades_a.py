...
with DAG(
    ...
    tarea_1=DummyOperator(task_id="Query_Flores")         #I will use the PythonOperator to do the query from "Universidad de Flores"
    tarea_2=DummyOperator(task_id="Query_Villa_Maria")    #I will use the PythonOperator to do the query from "Universidad de Villa Maria" 
